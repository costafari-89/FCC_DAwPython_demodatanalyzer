...
def calculate_demographic_data(print_data=True):
    ...
    high_earner_count = df[df['salary']=='>50K']['native-country'].value_counts()
        
    highest_earning_country = (high_earner_count/country_count).sort_values(ascending=False).index[0]
    highest_earning_country_percentage = round(((high_earner_count/country_count).sort_values(ascending=False).max())*100,1)
